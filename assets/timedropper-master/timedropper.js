    ...
    $.fn.timeDropper = function(options, callbackFnk) {
        return $(this).each(function() {
            ...
            var
                ...
                _td_rotation = function(deg) {
                    ...
                    if (t.index() == 0) {
                        ...
                        str = str.replace(/9/g, '۹');
                        t.text(str);
                        t.attr('data-id', _td_num(m)).text((str));
                    }
            ...
            var _td_init = function(value) {
                ...
                str_m=m.toString();
                str_m = str_m.replace(/0/g, '۰');
                str_m = str_m.replace(/1/g, '۱');
                str_m = str_m.replace(/2/g, '۲');
                str_m = str_m.replace(/3/g, '۳');
                str_m = str_m.replace(/4/g, '۴');
                str_m = str_m.replace(/5/g, '۵');
                str_m = str_m.replace(/6/g, '۶');
                str_m = str_m.replace(/7/g, '۷');
                str_m = str_m.replace(/8/g, '۸');
                str_m = str_m.replace(/9/g, '۹');
                _td_span_h.attr('data-id', h).text(h);
                _td_span_m.attr('data-id', m).text(str_m);
